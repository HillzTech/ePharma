...
*/
  ...
  <View style={{flexDirection:'row', justifyContent:'space-between',alignItems:'center', paddingHorizontal:wp('3%'), bottom:hp('1%'), position:'absolute', left:0, right:0, zIndex:10}}>
   ...
   <Text style={{fontFamily:'OpenSans-Bold', fontSize:RFValue(10), left:wp('5%'), opacity:0.6, bottom:hp('0.3')}}>Still in stock</Text>
          ...
          <TouchableOpacity onPress={() => handleIconPress('search', 'UploadScreen')} style={{ position: 'absolute',justifyContent: 'center', alignItems: 'center', top: hp('95%'), right: wp('1%'), left: 0,zIndex: 10 }}>
...
>
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: wp('8%') }}>
          <TouchableOpacity onPress={() => handleIconPress('home', 'RetailerScreen')}>
            <Ionicons name='home' size={iconSize} color={selectedIcon === 'home' ? 'blue' : 'black'} opacity={0.8}/>
          ...
          <MaterialIcons name="category" size={iconSize} color={selectedIcon === 'order' ? 'blue' : 'black'} opacity={0.8}/>
  ...
  <MaterialIcons name='inventory' size={smallSize} color={selectedIcon === 'user' ? 'blue' : 'black'} style={{ left: wp('3%') }} opacity={0.8}/>
  <Text style={{ fontFamily: 'Poppins-Bold', fontSize: RFValue(10), color: 'grey', right: wp('1.5%') }}>Inventory</Text>
</TouchableOpacity>

          <TouchableOpacity onPress={() => handleIconPress('medical', 'RetailProfileScreen')}>
            <FontAwesome5 name='user' size={smallSize} color={selectedIcon === 'medical' ? 'blue' : 'black'} style={{ left: wp('2%') }} opacity={0.8}/>
